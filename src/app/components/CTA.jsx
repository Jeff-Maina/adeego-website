...
const iossvg = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="apple" fill='#fff'className="size-6">
    <g fill-rule="evenodd">
      <path
...
const CTA = () => {
  return (
    <main className="w-full h-screen flex flex-col items-center justify-center gap-6 lg:gap-14 xl:gap-20 bg-neutral-100">
